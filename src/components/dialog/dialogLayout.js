...
export default class DialogLayout extends Component {
  ...
  render() {
    const {
      toastShow, toastContent, toastType, toastTime, alertShow, alertIconHide, alertType, alertChildren, alertTitleText, alertLabelText, confirmShow, confirmIconHide, confirmType, confirmChildren, confirmBtnType, confirmTitle, confirmcancelBtnText, confirmBtnText, alertWidth, MaskClick,
    } = this.state;
