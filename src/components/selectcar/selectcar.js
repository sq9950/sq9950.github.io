...
class SelectCar extends Component {
  ...
  brandClick(obj) {
    ...
    fetch(`${brandDataURL}seriesprice-pm1-b${obj.id}-t16-v8.2.0.json`)
      .then(response => response.json())
      .then((data) => {
        const list = data.result.fctlist;
        const otherlist = data.result.otherfctlist;
        let arr = [];
        list.map((ele) => {
...
SelectCar.defaultProps = {
  brandDataURL: '//raw.githubusercontent.com/yanshenshen/jimu-mobile/gh-pages/cartypedata/json/',
  staticImgURL: '//raw.githubusercontent.com/yanshenshen/jimu-mobile/gh-pages/cartypedata/brands/',
