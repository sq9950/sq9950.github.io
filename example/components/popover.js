...
const {Dialog,Button,Layouts,Switch,Popover} = JIMU,
  { Alert, Toast,Confirm,ContentTip,ToastLoad,NConfirm,Bubble} = Dialog,
  {Tooltip} = Popover,
  {
    Layout,
    LayoutHd,
...
const _Switch = React.createClass({
  ...
  handleChange() {
    let {directionSel,topSel,leftSel,alignSel} = this.refs
    this.setState({
      top : topSel.value,
      left : leftSel.value,
  ...
  render() {
    let {top,left,direction,align,closeBtnShow,show,width,popleftshow,poptopshow,popbottomshow,poprightshow,popleftmoreshow} = this.state
    return (
          ...
          <Layout>
            <Items className="jimu-items-list">
              <Item className="jimu-aside-right popover-items">
                ...
                <span className="tool-tip-btn" id="newIndex"></span>
              </Item>
              ...
              <Item className="jimu-aside-right popover-items">
                ...
                <span className="tool-tip-btn" id="newIndexright"></span>
              </Item>
              ...
              <Item className="jimu-aside-right popover-items">
                ...
                <span className="tool-tip-btn" id="newIndextop"></span>
              </Item>
              ...
              <Item className="jimu-aside-right popover-items">
                ...
                <span className="tool-tip-btn" id="newIndexbottom"></span>
              </Item>
              ...
              <Item className="jimu-aside-right popover-items">
                ...
                <span className="tool-tip-btn" id="newIndexleftmore"></span>
              </Item>
