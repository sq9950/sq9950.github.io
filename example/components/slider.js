    ...
    <div className="libs-intr" style={{"minHeight" : `${document.body.clientHeight - 124}px`}}>
      ...
      <div className="slider-layout" style={{margin:"0 30px"}}>
        ...
        <dl className="dl-list slider-list">
          ...
          <dt>分段颜色展示</dt>
          <dd><SliderLine defaultValue={0} min={0} max={10} colorStageGroup={[4]} colorGroup={["#fc9153","#52bca3"]}/></dd>

          <dt>分段颜色渐变展示</dt>
          <dd><SliderLine defaultValue={0} min={0} max={10} colorStageGroup={[4]} colorGroup={["#fc9153","#52bca3"]} isShading={true}/></dd>
        ...
        <dl className="dl-list">
          <dt>纯色滑动</dt>
          <dd><Sliders upChangeBack={slidecb} defaultValue={4} min={0} max={10} titleBefore="自定义标题前 " titleAfter=" 自定义标题后" /></dd>
          <dt>分段颜色展示</dt>
          <dd><Sliders upChangeBack={slidecb}  colorStageGroup={[4]} colorGroup={["#fc9153","#52bca3"]}  defaultValue={4} min={0} max={10} titleBefore="自定义标题前 " titleAfter=" 自定义标题后" /></dd>

          <dt>分段颜色渐变展示</dt>
          <dd><Sliders upChangeBack={slidecb}  colorStageGroup={[4]} colorGroup={["#fc9153","#52bca3"]}  defaultValue={4} min={0} max={10} titleBefore="自定义标题前 " titleAfter=" 自定义标题后"  isShading={true} /></dd>
