        ...
        <div className="component-wrap">
          ...
          <div className="component-layout">
            ...
            <div className="component-body" style={{ display: `${navShow[7] == 0 ? 'none' : 'block'}` }}>
              <ul className="component-items">
                <li><Link to="/csstransform"><b>css3过渡动画</b><span>CssTransform</span> <i className="icon-col-gt" /></Link></li>
                <li><Link to="/positiontransform"><b>模块间位置切换</b><span>PositionTransform</span> <i className="icon-col-gt" /></Link></li>
              </ul>
            </div>
          </div>
