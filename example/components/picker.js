...
const {Layouts,Picker} = JIMU,
  ...
  {TimePicker,DatePicker,TimeGroupPicker,DatePickerInstall,DatePickerNow,DataPickerBefore,ColumnPicker,CarNumberPicker,TimeSectionPicker} = Picker
...
const _Picker = React.createClass({
  ...
  render() {
    let {options01,onValue01,opt1,show01,oneShow,onevalue,oneopt,twoShow,twovalue,twoopt,carValue} = this.state
    return (
