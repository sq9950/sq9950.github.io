  ...
  _createClass(CarRecord, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = _objectWithoutProperties(_props, ['href', 'start_name', 'end_name', 'filedMap', 'create_time', 'className', 'use_car_type', 'require_level', 'pay_type', 'real_pay', 'tip_fee', 'other_fee', 'realname', 'superAdmin', 'drsFontLen', 'nameFontLen', 'nameSubstrLen', 'weekFormat', 'weekShow', 'dateFormat']);
