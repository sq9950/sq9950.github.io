...
var DateRangePicker = (_temp = _class = function (_Component) {
  ...
  _createClass(DateRangePicker, [{
    ...
    value: function onChange(val, text, listIndex) {
      ...
      // 当改变年份时
      if (listIndex == 0) {
        var yearval = this._deleteStrUnit(val, '年');
        // 当前年份
      ...
      // 当改变月份时
      if (listIndex == 1) {
        var mouthval = this._deleteStrUnit(val, '月');
        // 当前年份
    ...
    value: function _showFunc() {
      if (this.props.valueData != this.state.valueData) {
        var _props3 = this.props,
            valueData = _props3.valueData,
            endData = _props3.endData,
            startData = _props3.startData,
